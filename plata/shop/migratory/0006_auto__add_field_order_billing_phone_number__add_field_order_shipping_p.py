...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.billing_phone_number'
        db.add_column(u'shop_order', 'billing_phone_number',
                      self.gf('django.db.models.fields.CharField')(default=21, max_length=10),
                      keep_default=False)

        # Adding field 'Order.shipping_phone_number'
        db.add_column(u'shop_order', 'shipping_phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.billing_phone_number'
        db.delete_column(u'shop_order', 'billing_phone_number')

        # Deleting field 'Order.shipping_phone_number'
        db.delete_column(u'shop_order', 'shipping_phone_number')
