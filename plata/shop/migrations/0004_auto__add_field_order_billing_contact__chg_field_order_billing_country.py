...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.billing_contact'
        db.add_column(u'shop_order', 'billing_contact',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


        # Changing field 'Order.billing_country'
        db.alter_column(u'shop_order', 'billing_country', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Order.shipping_country'
        db.alter_column(u'shop_order', 'shipping_country', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'OrderItem.product'
        db.alter_column(u'shop_orderitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imly.Product'], null=True, on_delete=models.SET_NULL))

        # Changing field 'OrderItem._unit_price'
        db.alter_column(u'shop_orderitem', '_unit_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=0))

    def backwards(self, orm):
        # Deleting field 'Order.billing_contact'
        db.delete_column(u'shop_order', 'billing_contact')
        ...
        # Changing field 'Order.shipping_country'
        db.alter_column(u'shop_order', 'shipping_country', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'OrderItem.product'
        db.alter_column(u'shop_orderitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['simple.Product'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        u'shop.order': {
            ...
            'billing_contact': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
