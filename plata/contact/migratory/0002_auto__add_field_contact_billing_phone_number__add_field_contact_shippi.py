...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.billing_phone_number'
        db.add_column(u'contact_contact', 'billing_phone_number',
                      self.gf('django.db.models.fields.CharField')(default=23, max_length=10),
                      keep_default=False)

        # Adding field 'Contact.shipping_phone_number'
        db.add_column(u'contact_contact', 'shipping_phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


        # Changing field 'Contact.shipping_country'
        db.alter_column(u'contact_contact', 'shipping_country', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Contact.billing_country'
        db.alter_column(u'contact_contact', 'billing_country', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting field 'Contact.billing_phone_number'
        db.delete_column(u'contact_contact', 'billing_phone_number')

        # Deleting field 'Contact.shipping_phone_number'
        db.delete_column(u'contact_contact', 'shipping_phone_number')


        # Changing field 'Contact.shipping_country'
        db.alter_column(u'contact_contact', 'shipping_country', self.gf('django.db.models.fields.CharField')(max_length=3))
