...
class Product(ProductBase, PriceBase, geo_models.Model):
    ...
    image_thumbnail = ImageSpecField(image_field="image", format="JPEG",options={'quality': 60}, processors = [ResizeToFill(300,200)], cache_to=get_thumbnail_path)
    image_thumbnail_mini = ImageSpecField(image_field="image", format="JPEG",options={'quality': 60}, processors = [ResizeToFill(100,80)], cache_to=get_thumbnail_mini_path)
    image_thumbnail_large = ImageSpecField(image_field="image", format="JPEG",options={'quality':60}, processors = [ResizeToFit(width=575)], cache_to=get_thumbnail_large_path)
