...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.pick_up_landmark'
        db.add_column(u'imly_store', 'pick_up_landmark',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.pick_up_landmark'
        db.delete_column(u'imly_store', 'pick_up_landmark')
