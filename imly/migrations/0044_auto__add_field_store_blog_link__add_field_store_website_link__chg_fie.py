...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.blog_link'
        db.add_column(u'imly_store', 'blog_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Store.website_link'
        db.add_column(u'imly_store', 'website_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Store.store_notice'
        db.alter_column(u'imly_store', 'store_notice', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Store.store_contact_number'
        db.alter_column(u'imly_store', 'store_contact_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Store.tagline'
        db.alter_column(u'imly_store', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Store.pick_up_address'
        db.alter_column(u'imly_store', 'pick_up_address', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Store.pick_up_landmark'
        db.alter_column(u'imly_store', 'pick_up_landmark', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Store.twitter_link'
        db.alter_column(u'imly_store', 'twitter_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Store.facebook_link'
        db.alter_column(u'imly_store', 'facebook_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Store.pick_up_location'
        db.alter_column(u'imly_store', 'pick_up_location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Store.blog_link'
        db.delete_column(u'imly_store', 'blog_link')

        # Deleting field 'Store.website_link'
        db.delete_column(u'imly_store', 'website_link')


        # Changing field 'Store.store_notice'
        db.alter_column(u'imly_store', 'store_notice', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Store.store_contact_number'
        db.alter_column(u'imly_store', 'store_contact_number', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Store.tagline'
        db.alter_column(u'imly_store', 'tagline', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Store.pick_up_address'
        db.alter_column(u'imly_store', 'pick_up_address', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Store.pick_up_landmark'
        db.alter_column(u'imly_store', 'pick_up_landmark', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Store.twitter_link'
        db.alter_column(u'imly_store', 'twitter_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Store.facebook_link'
        db.alter_column(u'imly_store', 'facebook_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Store.pick_up_location'
        db.alter_column(u'imly_store', 'pick_up_location', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        u'imly.ingredient': {
            ...
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ingredients'", 'to': u"orm['imly.Recipe']"})
        },
        u'imly.location': {
        ...
        u'imly.product': {
            ...
            'flag_reason': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'is_bestseller': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'quantity_per_item': ('django.db.models.fields.DecimalField', [], {'default': '1', 'max_digits': '6', 'decimal_places': '2'}),
            ...
            'user': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'through': u"orm['imly.Wish']", 'symmetrical': 'False'})
        },
        u'imly.recipe': {
            'Meta': {'object_name': 'Recipe'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['imly.Category']"}),
            'chef_note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'cook_time': ('django.db.models.fields.FloatField', [], {}),
            'cook_time_choices': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prep_time': ('django.db.models.fields.FloatField', [], {}),
            'prep_time_choices': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'product': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['imly.Product']", 'unique': 'True'}),
            'serves': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['imly.Store']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'imly.recipestep': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'steps'", 'to': u"orm['imly.Recipe']"})
        },
        u'imly.special': {
        ...
        u'imly.store': {
            ...
            'pick_up_address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'pick_up_landmark': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'pick_up_location': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'pick_up_point': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'provide_delivery': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': "'name'", 'unique_with': '()'}),
            'store_contact_number': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'store_notice': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'tagline': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['imly.Tag']", 'symmetrical': 'False', 'blank': 'True'}),
            'twitter_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'website_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'imly.storeorder': {
            'Meta': {'ordering': "['-delivered_on']", 'object_name': 'StoreOrder'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)'}),
        ...
        u'imly.wish': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['imly.Product']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
