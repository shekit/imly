...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'imly_recipeingredient')

        # Deleting field 'Ingredient.source'
        db.delete_column(u'imly_ingredient', 'source')

        # Deleting field 'Ingredient.slug'
        db.delete_column(u'imly_ingredient', 'slug')

        # Adding field 'Ingredient.recipe'
        db.add_column(u'imly_ingredient', 'recipe',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['imly.Recipe']),
                      keep_default=False)


        # Changing field 'Ingredient.name'
        db.alter_column(u'imly_ingredient', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding model 'RecipeIngredient'
        db.create_table(u'imly_recipeingredient', (
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imly.Recipe'])),
            ('quantity_type', self.gf('django.db.models.fields.IntegerField')()),
            ('ingredient_description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ingredient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imly.Ingredient'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'imly', ['RecipeIngredient'])

        # Adding field 'Ingredient.source'
        db.add_column(u'imly_ingredient', 'source',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Ingredient.slug'
        db.add_column(u'imly_ingredient', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', max_length=100, unique_with=(), unique=True, populate_from='name'),
                      keep_default=False)

        # Deleting field 'Ingredient.recipe'
        db.delete_column(u'imly_ingredient', 'recipe_id')


        # Changing field 'Ingredient.name'
        db.alter_column(u'imly_ingredient', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 25, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 25, 0, 0)'}),
