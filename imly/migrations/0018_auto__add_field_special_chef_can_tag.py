...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Special.chef_can_tag'
        db.add_column(u'imly_special', 'chef_can_tag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Special.chef_can_tag'
        db.delete_column(u'imly_special', 'chef_can_tag')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 0, 0)'}),
