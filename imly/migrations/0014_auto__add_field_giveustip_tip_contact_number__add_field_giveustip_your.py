...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GiveUsTip.tip_contact_number'
        db.add_column(u'imly_giveustip', 'tip_contact_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'GiveUsTip.your_name'
        db.add_column(u'imly_giveustip', 'your_name',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GiveUsTip.tip_contact_number'
        db.delete_column(u'imly_giveustip', 'tip_contact_number')

        # Deleting field 'GiveUsTip.your_name'
        db.delete_column(u'imly_giveustip', 'your_name')
