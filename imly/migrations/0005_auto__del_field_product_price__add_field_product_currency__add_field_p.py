...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'imly_product', 'price')

        # Adding field 'Product.currency'
        db.add_column(u'imly_product', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='INR', max_length=3),
                      keep_default=False)

        # Adding field 'Product._unit_price'
        db.add_column(u'imly_product', '_unit_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=18, decimal_places=10),
                      keep_default=False)

        # Adding field 'Product.tax_included'
        db.add_column(u'imly_product', 'tax_included',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Product.tax_class'
        db.add_column(u'imly_product', 'tax_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['shop.TaxClass']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.price'
        db.add_column(u'imly_product', 'price',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Product.currency'
        db.delete_column(u'imly_product', 'currency')

        # Deleting field 'Product._unit_price'
        db.delete_column(u'imly_product', '_unit_price')

        # Deleting field 'Product.tax_included'
        db.delete_column(u'imly_product', 'tax_included')

        # Deleting field 'Product.tax_class'
        db.delete_column(u'imly_product', 'tax_class_id')
