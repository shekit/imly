...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.store_contact_number'
        db.add_column(u'imly_store', 'store_contact_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'Store.facebook_link'
        db.add_column(u'imly_store', 'facebook_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Store.twitter_link'
        db.add_column(u'imly_store', 'twitter_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Store.store_notice'
        db.add_column(u'imly_store', 'store_notice',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Product.quantity_per_item'
        db.add_column(u'imly_product', 'quantity_per_item',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Product.quantity_by_price'
        db.add_column(u'imly_product', 'quantity_by_price',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Product.lead_time_unit'
        db.add_column(u'imly_product', 'lead_time_unit',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


        # Changing field 'Product._unit_price'
        db.alter_column(u'imly_product', '_unit_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=0))

    def backwards(self, orm):
        # Deleting field 'Store.store_contact_number'
        db.delete_column(u'imly_store', 'store_contact_number')

        # Deleting field 'Store.facebook_link'
        db.delete_column(u'imly_store', 'facebook_link')

        # Deleting field 'Store.twitter_link'
        db.delete_column(u'imly_store', 'twitter_link')

        # Deleting field 'Store.store_notice'
        db.delete_column(u'imly_store', 'store_notice')

        # Deleting field 'Product.quantity_per_item'
        db.delete_column(u'imly_product', 'quantity_per_item')

        # Deleting field 'Product.quantity_by_price'
        db.delete_column(u'imly_product', 'quantity_by_price')

        # Deleting field 'Product.lead_time_unit'
        db.delete_column(u'imly_product', 'lead_time_unit')


        # Changing field 'Product._unit_price'
        db.alter_column(u'imly_product', '_unit_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))
