...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StoreOrder.suggest_to_chef'
        db.delete_column(u'imly_storeorder', 'suggest_to_chef')

        # Adding field 'StoreOrder.note'
        db.add_column(u'imly_storeorder', 'note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StoreOrder.suggest_to_chef'
        db.add_column(u'imly_storeorder', 'suggest_to_chef',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'StoreOrder.note'
        db.delete_column(u'imly_storeorder', 'note')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 7, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 7, 0, 0)'}),
