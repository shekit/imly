...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'imly_recipe', 'slug')

        # Deleting field 'Recipe.name'
        db.delete_column(u'imly_recipe', 'name')


    def backwards(self, orm):
        # Adding field 'Recipe.slug'
        db.add_column(u'imly_recipe', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', max_length=255, unique_with=(), unique=True, populate_from='name'),
                      keep_default=False)

        # Adding field 'Recipe.name'
        db.add_column(u'imly_recipe', 'name',
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 24, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 24, 0, 0)'}),
