...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StoreOrder.store_total'
        db.alter_column(u'imly_storeorder', 'store_total', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'StoreOrder.store_total'
        db.alter_column(u'imly_storeorder', 'store_total', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
