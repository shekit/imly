...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.is_open'
        db.add_column(u'imly_store', 'is_open',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.about_me_html'
        db.add_column(u'imly_userprofile', 'about_me_html',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.is_open'
        db.delete_column(u'imly_store', 'is_open')

        # Deleting field 'UserProfile.about_me_html'
        db.delete_column(u'imly_userprofile', 'about_me_html')
