...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Special.special_button_photo'
        db.add_column(u'imly_special', 'special_button_photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Special.special_button_photo'
        db.delete_column(u'imly_special', 'special_button_photo')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 0, 0)'}),
