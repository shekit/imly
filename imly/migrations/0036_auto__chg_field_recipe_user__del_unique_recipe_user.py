...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Recipe', fields ['user']
        db.delete_unique(u'imly_recipe', ['user_id'])


        # Changing field 'Recipe.user'
        db.alter_column(u'imly_recipe', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Recipe.user'
        db.alter_column(u'imly_recipe', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Recipe', fields ['user']
        db.create_unique(u'imly_recipe', ['user_id'])
