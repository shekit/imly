...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipeIngredient.ingredient_description'
        db.add_column(u'imly_recipeingredient', 'ingredient_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Recipe.cook_time'
        db.add_column(u'imly_recipe', 'cook_time',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Recipe.cook_time_choices'
        db.add_column(u'imly_recipe', 'cook_time_choices',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Recipe.serves'
        db.add_column(u'imly_recipe', 'serves',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecipeIngredient.ingredient_description'
        db.delete_column(u'imly_recipeingredient', 'ingredient_description')

        # Deleting field 'Recipe.cook_time'
        db.delete_column(u'imly_recipe', 'cook_time')

        # Deleting field 'Recipe.cook_time_choices'
        db.delete_column(u'imly_recipe', 'cook_time_choices')

        # Deleting field 'Recipe.serves'
        db.delete_column(u'imly_recipe', 'serves')
    ...
    models = {
        ...
        u'imly.recipeingredient': {
            ...
            'ingredient_description': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
