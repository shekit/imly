...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreOrder.delivered_by_product_lead'
        db.add_column(u'imly_storeorder', 'delivered_by_product_lead',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreOrder.delivered_by_product_lead'
        db.delete_column(u'imly_storeorder', 'delivered_by_product_lead')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 1, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 1, 0, 0)'}),
