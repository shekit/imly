...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.rating_votes'
        db.add_column(u'imly_product', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Product.rating_score'
        db.add_column(u'imly_product', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.rating_votes'
        db.delete_column(u'imly_product', 'rating_votes')

        # Deleting field 'Product.rating_score'
        db.delete_column(u'imly_product', 'rating_score')
