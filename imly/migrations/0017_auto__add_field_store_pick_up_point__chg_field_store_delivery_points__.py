...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.delivery_points'
        db.alter_column(u'imly_store', 'delivery_points', self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True))
        # Deleting field 'DeliveryLocation.bounds'
        db.delete_column(u'imly_deliverylocation', 'bounds')

        # Deleting field 'DeliveryLocation.data'
        db.delete_column(u'imly_deliverylocation', 'data')


        # Changing field 'DeliveryLocation.location'
        db.alter_column(u'imly_deliverylocation', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))

    def backwards(self, orm):

        # Changing field 'Store.delivery_points'
        db.alter_column(u'imly_store', 'delivery_points', self.gf('django.contrib.gis.db.models.fields.MultiPointField')())
        # Adding field 'DeliveryLocation.bounds'
        db.add_column(u'imly_deliverylocation', 'bounds',
                      self.gf('django.contrib.gis.db.models.fields.PolygonField')(default=u'POLYGON ((19.2695223999999996 72.9800522999999970, 19.2695223999999996 72.7759056000000015, 18.8933086999999986 72.7759056000000015, 18.8933086999999986 72.9800522999999970, 19.2695223999999996 72.9800522999999970))', blank=True),
                      keep_default=False)

        # Adding field 'DeliveryLocation.data'
        db.add_column(u'imly_deliverylocation', 'data',
                      self.gf('plata.fields.JSONField')(default='{}', blank=True),
                      keep_default=False)


        # Changing field 'DeliveryLocation.location'
        db.alter_column(u'imly_deliverylocation', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')())
