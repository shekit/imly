...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.pick_up_location'
        db.add_column(u'imly_store', 'pick_up_location',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.pick_up_location'
        db.delete_column(u'imly_store', 'pick_up_location')
    ...
    models = {
        ...
        u'imly.store': {
            ...
            'pick_up_location': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
