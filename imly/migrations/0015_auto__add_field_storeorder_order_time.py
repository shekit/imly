...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreOrder.order_time'
        db.add_column(u'imly_storeorder', 'order_time',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreOrder.order_time'
        db.delete_column(u'imly_storeorder', 'order_time')
