...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.position'
        db.alter_column(u'imly_product', 'position', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Product.position'
        db.alter_column(u'imly_product', 'position', self.gf('django.db.models.fields.IntegerField')())
