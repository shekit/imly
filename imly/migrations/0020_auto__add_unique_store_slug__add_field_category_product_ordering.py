...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.product_ordering'
        db.add_column(u'imly_category', 'product_ordering',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Category.product_ordering'
        db.delete_column(u'imly_category', 'product_ordering')
    ...
    models = {
        ...
        u'imly.product': {
            'Meta': {'ordering': "['category__product_ordering', 'position', 'store']", 'unique_together': "(('name', 'store'),)", 'object_name': 'Product'},
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 22, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 22, 0, 0)'}),
