...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.cover_profile_image'
        db.add_column(u'imly_userprofile', 'cover_profile_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.word_one'
        db.add_column(u'imly_userprofile', 'word_one',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.word_two'
        db.add_column(u'imly_userprofile', 'word_two',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.word_three'
        db.add_column(u'imly_userprofile', 'word_three',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.cover_profile_image'
        db.delete_column(u'imly_userprofile', 'cover_profile_image')

        # Deleting field 'UserProfile.word_one'
        db.delete_column(u'imly_userprofile', 'word_one')

        # Deleting field 'UserProfile.word_two'
        db.delete_column(u'imly_userprofile', 'word_two')

        # Deleting field 'UserProfile.word_three'
        db.delete_column(u'imly_userprofile', 'word_three')
