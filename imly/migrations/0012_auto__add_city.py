...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'City'
        db.create_table(u'imly_city', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('enclosing_geometry', self.gf('django.contrib.gis.db.models.fields.PolygonField')(blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'imly', ['City'])


    def backwards(self, orm):
        # Deleting model 'City'
        db.delete_table(u'imly_city')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 10, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 10, 0, 0)'}),
