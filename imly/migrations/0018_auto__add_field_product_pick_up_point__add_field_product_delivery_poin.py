...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.pick_up_point'
        db.add_column(u'imly_product', 'pick_up_point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.delivery_points'
        db.add_column(u'imly_product', 'delivery_points',
                      self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.pick_up_point'
        db.delete_column(u'imly_product', 'pick_up_point')

        # Deleting field 'Product.delivery_points'
        db.delete_column(u'imly_product', 'delivery_points')
