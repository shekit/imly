...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'imly_supercategory')


        # Changing field 'Category.super_category'
        db.alter_column(u'imly_category', 'super_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imly.Category']))

    def backwards(self, orm):
        # Adding model 'SuperCategory'
        db.create_table(u'imly_supercategory', (
        ...
        db.send_create_signal(u'imly', ['SuperCategory'])


        # Changing field 'Category.super_category'
        db.alter_column(u'imly_category', 'super_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imly.SuperCategory']))
    ...
    models = {
        ...
        u'imly.category': {
            ...
            'super_category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sub_categories'", 'blank': 'True', 'to': u"orm['imly.Category']"})
        },
        u'imly.location': {
