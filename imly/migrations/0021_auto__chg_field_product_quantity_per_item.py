...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.quantity_per_item'
        db.alter_column(u'imly_product', 'quantity_per_item', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'imly.product': {
            ...
            'quantity_per_item': ('django.db.models.fields.FloatField', [], {'default': '1.0'}),
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)'}),
