...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'imly_store', 'pick_up_location', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'StoreOrder.delivered_on_lead'
        db.add_column(u'imly_storeorder', 'delivered_on_lead',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'StoreOrder.pick_up'
        db.add_column(u'imly_storeorder', 'pick_up',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Store.pick_up_location'
        db.alter_column(u'imly_store', 'pick_up_location', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Deleting field 'StoreOrder.delivered_on_lead'
        db.delete_column(u'imly_storeorder', 'delivered_on_lead')

        # Deleting field 'StoreOrder.pick_up'
        db.delete_column(u'imly_storeorder', 'pick_up')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
            'delivered_on_lead': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
