...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.data'
        db.add_column(u'imly_store', 'data',
                      self.gf('plata.fields.JSONField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.data'
        db.delete_column(u'imly_store', 'data')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 30, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
