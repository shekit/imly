...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.provide_delivery'
        db.add_column(u'imly_store', 'provide_delivery',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.provide_delivery'
        db.delete_column(u'imly_store', 'provide_delivery')
