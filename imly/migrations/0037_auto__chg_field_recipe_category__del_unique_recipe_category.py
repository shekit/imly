...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Recipe', fields ['category']
        db.delete_unique(u'imly_recipe', ['category_id'])


        # Changing field 'Recipe.category'
        db.alter_column(u'imly_recipe', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imly.Category']))

    def backwards(self, orm):

        # Changing field 'Recipe.category'
        db.alter_column(u'imly_recipe', 'category_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['imly.Category'], unique=True))
        # Adding unique constraint on 'Recipe', fields ['category']
        db.create_unique(u'imly_recipe', ['category_id'])
