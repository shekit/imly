...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreOrder.delivery_lead'
        db.add_column(u'imly_storeorder', 'delivery_lead',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StoreOrder.delivery_lead'
        db.delete_column(u'imly_storeorder', 'delivery_lead')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 31, 0, 0)'}),
