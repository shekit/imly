...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'imly_recipestep', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imly.Recipe'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'imly', ['RecipeStep'])

        # Adding model 'Ingredient'
        db.create_table(u'imly_ingredient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'imly', ['Ingredient'])

        # Adding model 'RecipeIngredient'
        db.create_table(u'imly_recipeingredient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ingredient_quantity', self.gf('django.db.models.fields.IntegerField')()),
        ...
        # Adding model 'Recipe'
        db.create_table(u'imly_recipe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from='name', unique_with=())),
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['imly.Product'], unique=True)),
            ('category', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['imly.Category'], unique=True)),
            ...
            ('prep_time_choices', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('chef_note', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'imly', ['Recipe'])


    def backwards(self, orm):
        # Deleting model 'RecipeStep'
        db.delete_table(u'imly_recipestep')

        # Deleting model 'Ingredient'
        db.delete_table(u'imly_ingredient')

        # Deleting model 'RecipeIngredient'
        db.delete_table(u'imly_recipeingredient')

        # Deleting model 'Recipe'
        db.delete_table(u'imly_recipe')
    ...
    models = {
        ...
        u'imly.recipeingredient': {
            ...
            'ingredient_quantity': ('django.db.models.fields.IntegerField', [], {}),
