...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ingredient.slug'
        db.add_column(u'imly_ingredient', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique=True, max_length=100, populate_from='name', unique_with=()),
                      keep_default=False)

        # Deleting field 'RecipeIngredient.ingredient_quantity'
        db.delete_column(u'imly_recipeingredient', 'ingredient_quantity')

        # Adding field 'RecipeIngredient.quantity'
        db.add_column(u'imly_recipeingredient', 'quantity',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

        # Adding field 'RecipeIngredient.quantity_type'
        db.add_column(u'imly_recipeingredient', 'quantity_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Recipe.slug'
        db.alter_column(u'imly_recipe', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=255, populate_from='name', unique_with=()))

    def backwards(self, orm):
        # Deleting field 'Ingredient.slug'
        db.delete_column(u'imly_ingredient', 'slug')

        # Adding field 'RecipeIngredient.ingredient_quantity'
        db.add_column(u'imly_recipeingredient', 'ingredient_quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'RecipeIngredient.quantity'
        db.delete_column(u'imly_recipeingredient', 'quantity')

        # Deleting field 'RecipeIngredient.quantity_type'
        db.delete_column(u'imly_recipeingredient', 'quantity_type')


        # Changing field 'Recipe.slug'
        db.alter_column(u'imly_recipe', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from='name'))
    ...
    models = {
        ...
        u'imly.recipe': {
            ...
            'category': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['imly.Category']", 'unique': 'True'}),
            'chef_note': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredients': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['imly.Ingredient']", 'through': u"orm['imly.RecipeIngredient']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'imly.recipeingredient': {
            'Meta': {'object_name': 'RecipeIngredient'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredient': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['imly.Ingredient']"}),
            'quantity': ('django.db.models.fields.FloatField', [], {}),
            'quantity_type': ('django.db.models.fields.IntegerField', [], {}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['imly.Recipe']"})
        },
        u'imly.recipestep': {
        ...
        u'imly.store': {
            ...
            'pick_up_location': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'pick_up_point': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 22, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 22, 0, 0)'}),
