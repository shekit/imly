...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'imly_category', 'super_category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['imly.Category']))

    def backwards(self, orm):

        # Changing field 'Category.super_category'
        db.alter_column(u'imly_category', 'super_category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['imly.Category']))
