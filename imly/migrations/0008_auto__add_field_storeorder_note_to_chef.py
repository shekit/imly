...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreOrder.note_to_chef'
        db.add_column(u'imly_storeorder', 'note_to_chef',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreOrder.note_to_chef'
        db.delete_column(u'imly_storeorder', 'note_to_chef')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note_to_chef': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'suggest_to_chef': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
