...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'imly_store', ['slug'])


        # Changing field 'Store.slug'
        db.alter_column(u'imly_store', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from='name'))

        # Changing field 'Product.slug'
        db.alter_column(u'imly_product', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=['store__name', 'name'], max_length=50, populate_from='name'))

    def backwards(self, orm):

        # Changing field 'Store.slug'
        db.alter_column(u'imly_store', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
        # Adding unique constraint on 'Store', fields ['slug']
        db.create_unique(u'imly_store', ['slug'])


        # Changing field 'Product.slug'
        db.alter_column(u'imly_product', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 3, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 3, 0, 0)'}),
