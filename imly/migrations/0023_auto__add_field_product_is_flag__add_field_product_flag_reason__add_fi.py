...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.is_flag'
        db.add_column(u'imly_product', 'is_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.flag_reason'
        db.add_column(u'imly_product', 'flag_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Product.data'
        db.add_column(u'imly_product', 'data',
    ...
    def backwards(self, orm):
        # Deleting field 'Product.is_flag'
        db.delete_column(u'imly_product', 'is_flag')

        # Deleting field 'Product.flag_reason'
        db.delete_column(u'imly_product', 'flag_reason')

        # Deleting field 'Product.data'
        db.delete_column(u'imly_product', 'data')
    ...
    models = {
        ...
        u'imly.product': {
            ...
            'quantity_per_item': ('django.db.models.fields.DecimalField', [], {'default': '1.0', 'max_digits': '6', 'decimal_places': '2'}),
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 26, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 26, 0, 0)'}),
