...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StoreOrder.store_items'
        db.delete_column(u'imly_storeorder', 'store_items')


    def backwards(self, orm):
        # Adding field 'StoreOrder.store_items'
        db.add_column(u'imly_storeorder', 'store_items',
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
