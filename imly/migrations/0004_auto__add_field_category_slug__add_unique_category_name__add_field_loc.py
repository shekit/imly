...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'imly_category', 'slug',
        ...
        db.create_unique(u'imly_category', ['name'])

        # Adding field 'Location.slug'
        db.add_column(u'imly_location', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'imly_category', ['name'])

        # Deleting field 'Category.slug'
        db.delete_column(u'imly_category', 'slug')

        # Deleting field 'Location.slug'
        db.delete_column(u'imly_location', 'slug')
