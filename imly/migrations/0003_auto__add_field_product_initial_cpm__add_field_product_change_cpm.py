...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.change_cpm'
        db.add_column(u'imly_product', 'change_cpm',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.change_cpm'
        db.delete_column(u'imly_product', 'change_cpm')
    ...
    models = {
        ...
        u'imly.product': {
            ...
            'change_cpm': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
