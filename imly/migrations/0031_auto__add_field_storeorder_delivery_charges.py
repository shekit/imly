...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreOrder.delivery_charges'
        db.add_column(u'imly_storeorder', 'delivery_charges',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreOrder.delivery_charges'
        db.delete_column(u'imly_storeorder', 'delivery_charges')
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_by_product_lead': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 15, 0, 0)'}),
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 15, 0, 0)'}),
