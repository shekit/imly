...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'imly_product', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.slug'
        db.alter_column(u'imly_product', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Product.name'
        db.alter_column(u'imly_product', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
