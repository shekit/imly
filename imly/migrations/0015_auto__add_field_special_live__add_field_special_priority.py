...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Special.live'
        db.add_column(u'imly_special', 'live',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Special.priority'
        db.add_column(u'imly_special', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Special.live'
        db.delete_column(u'imly_special', 'live')

        # Deleting field 'Special.priority'
        db.delete_column(u'imly_special', 'priority')
