...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'imly_userprofile', 'avatar')


    def backwards(self, orm):
        # Adding field 'UserProfile.avatar'
        db.add_column(u'imly_userprofile', 'avatar',
    ...
    models = {
        ...
        u'imly.storeorder': {
            ...
            'delivered_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
